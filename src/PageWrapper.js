	...
	<div className="container">
		<div className="row ipad-width2">
			<div className="col-md-8 col-sm-12 col-xs-12">
				...
				<Pelicula titulo="oblivion (2012)" calificaion ="9.1" director="Joss Whedon" actores="Robert Downey Jr.,Chris Evans,  Chris Hemsworth" fecha="May 2015" duracion="2h 21min" img="images/uploads/mv1.jpg">
          		Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity...
        		</Pelicula>
				<Pelicula titulo="into the wild (201)" calificaion ="9.1" director="Joss Whedon" actores="Robert Downey Jr.,Chris Evans,  Chris Hemsworth" fecha="May 2015" duracion="2h 21min" img="images/uploads/mv2.jpg">
          		Earth's mightiest heroes must come together and learn to fight as a team if they are to stop the mischievous Loki and his alien army from enslaving humanity...
        		</Pelicula>
